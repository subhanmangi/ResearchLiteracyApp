...
import com.example.rla.databinding.ActivityMainBinding;
...
public class ViewProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            String uri = "@drawable/profile";  // where myresource (without the extension) is the file
    ...
    private void uploadProfilePic() {
        //contentUri = Uri.parse("android.resource://"+getPackageName()+""+R.drawable.profile);
        storageReference = FirebaseStorage.getInstance().getReference("Users/"+auth.getCurrentUser().getUid());
        storageReference.putFile(contentUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                hideProgressBar();
           Toast.makeText(ViewProfile.this, "Image Uploaded to Firebase", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                hideProgressBar();
                Toast.makeText(ViewProfile.this, "Image not Uploaded", Toast.LENGTH_SHORT).show();
            }
        });
    }
